...
META = {
    "asof": "22 July 2026",
    # Updated automatically from market.json each run:
    "spy": 761.24,
    "qqq": 632.10,
    "bno": 34.85,
    "gld": 385.40,
    # Manual. Neither is a traded security, so there is no price to fetch.
    # The 10-year yield moves daily; check treasury.gov when you refresh the
    # market context. Fed funds only changes at FOMC meetings, ~8 times a year.
    "rf": 4.63,
    "fedfunds": "3.50–3.75%",
}

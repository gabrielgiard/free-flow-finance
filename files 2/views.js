  ...
  <section class="hero">
    ...
    <div class="wrap">
      ...
      <div class="snapshot-strip">
        <div class="snap-item"><div class="snap-label">S&amp;P 500 ETF · SPY</div><div class="snap-value">$${m.spy}</div>${marketSparkSVG('SPY')}</div>
        <div class="snap-item"><div class="snap-label">Nasdaq 100 ETF · QQQ</div><div class="snap-value">$${m.qqq}</div>${marketSparkSVG('QQQ')}</div>
        <div class="snap-item"><div class="snap-label">Brent Oil ETF · BNO</div><div class="snap-value">$${m.bno}</div>${marketSparkSVG('BNO')}</div>
        <div class="snap-item"><div class="snap-label">Gold ETF · GLD</div><div class="snap-value">$${m.gld}</div>${marketSparkSVG('GLD')}</div>
        ...
        <div class="snap-item"><div class="snap-label">Prices as of</div><div class="snap-value">${m.asof}</div></div>
      </div>
    </div>
  </section>
